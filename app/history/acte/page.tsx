...
const fakeData = [
  { name: "Alice K.", date: "2025-05-27", actes: 2, price: 15000 },
  { name: "Bob T.", date: "2025-05-26", actes: 1, price: 8000 },
  { name: "Chantal N.", date: "2025-05-20", actes: 3, price: 24000 },
  { name: "David M.", date: "2025-05-01", actes: 1, price: 5000 },
  { name: "Elise O.", date: "2025-05-15", actes: 4, price: 28000 },
  { name: "Fabrice G.", date: "2025-05-25", actes: 2, price: 18000 },
  { name: "Gisèle B.", date: "2025-05-27", actes: 1, price: 7000 },
  { name: "Henri Z.", date: "2025-04-28", actes: 3, price: 21000 },
  { name: "Isaac L.", date: "2025-05-02", actes: 2, price: 13000 },
]
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow sticky top-0 z-50 border-b border-blue-200">
        <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
          <h1 className="text-2xl font-bold text-blue-700">Historique des actes médicaux</h1>
          <button
            onClick={() => router.push("/acte")}
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-blue-100">
              <tr>
                ...
                <th className="px-4 py-3 text-sm font-semibold text-gray-700">Nb actes</th>
              ...
              {displayedData.length > 0 ? (
                displayedData.map((item, idx) => (
                  <tr key={idx} className="hover:bg-gray-50 transition">
                    ...
                    <td className="px-4 py-3">{item.actes}</td>
