...
const fakeData = [
  { name: "Alice K.", date: "2025-05-27", type: "Générale", price: 10000 },
  { name: "Bob T.", date: "2025-05-26", type: "Spécialisée", price: 20000 },
  { name: "Chantal N.", date: "2025-05-20", type: "Urgente", price: 30000 },
  { name: "David M.", date: "2025-05-01", type: "Générale", price: 10000 },
  { name: "Elise O.", date: "2025-05-15", type: "Spécialisée", price: 20000 },
  { name: "Fabrice G.", date: "2025-05-25", type: "Générale", price: 10000 },
  { name: "Gisèle B.", date: "2025-05-27", type: "Urgente", price: 30000 },
  { name: "Henri Z.", date: "2025-04-28", type: "Générale", price: 10000 },
  { name: "Isaac L.", date: "2025-05-02", type: "Spécialisée", price: 20000 },
]

const filters = ["Aujourd'hui", "Hier", "Cette semaine", "Ce mois", "Tout"]

export default function HistoriqueConsultationsPage() {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow sticky top-0 z-50 border-b border-blue-200">
        <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
          <h1 className="text-2xl font-bold text-blue-700">Historique des consultations</h1>
          <button
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-blue-100">
              <tr>
                ...
                <th className="px-4 py-3 text-sm font-semibold text-gray-700">Prix</th>
